...
const SupervisorPage = () => {
  ...
  const submitRequest = () => {
    ...
    const message =
      requestMessage?.trim() ||
      `${authUser.name || "Student"} has requested you to be their supervisor.`;
    dispatch(
      requestSupervisor({
              ...
              <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium capitalize ${project.status === "approved" ? "bg-green-100 text-green-800" : project.status === "rejected" ? "bg-red-100 text-red-800" : project.status === "pending" ? "bg-yellow-100 text-yellow-800" : "bg-gray-100 text-gray-800"}`}
                      >
          ...
          <div className="card">
            <div className="card-header">
              ...
              <p className="card-subtitle">
                Browse and request Supervison from available faculty member
              </p>
            </div>
