  ...
  <div className="space-y-6">
    <div className="card">
      <div className="card-header">
        <h2 className="card-title">Upload Project Files</h2>
        <p className="card-subtitle">Upload your project documents including reports, presentation, and code files.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <p className="text-sm text-slate-600 mb-4">Upload your project report (PDF, DOCX)</p>
            <label className="btn-outline cursor-pointer">Choose Files
              <input type="file" ref={reportRef} className="hidden" accept=".pdf,.docx,doc" onChange={handleFilePick} multiple />
            </label>
          </div>
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            <div className="mb-4">
          ...
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <label className="btn-outline cursor-pointer">Choose Files
              <input type="file" ref={codeRef} className="hidden" accept=".zip,.rar,.tar,.gz" onChange={handleFilePick} multiple />
            </label>
          </div>
      </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 text-sm">
                        <span className="">{(file.size / (1024 * 1024).toFixed(1))} MB</span>
                      </div>
                    </div>
                  </div>
                  <button className="btn-danger btn-small" onClick={() => removeSelected(file.name)}>
                    Remove
                  </button>
                </div>
              )
